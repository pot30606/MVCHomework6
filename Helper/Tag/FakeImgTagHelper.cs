...
{
    [HtmlTargetElement("f-img")]
    public class FakeImgTagHelper : TagHelper
    {
        ...
        public FakeImgTagHelper(IUrlHelperFactory urlHelperFactory, IActionContextAccessor accessor)
        {
